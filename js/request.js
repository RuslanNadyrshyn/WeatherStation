...
var getWeather = function (city) {      // Функція, яка виконує запит до API для отримання
    $.ajax({							// даних погоди обраного міста
        type: "GET",
        url: "php/get_weather.php?city=" + city,
        dataType: "json",
...
/*
Функція, яка за допомогою ajax-запиту до файла "php/fetch_db.php" отримує дані таблиці
